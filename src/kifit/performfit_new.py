...
def minimise_logL_alphaNP(
    ...
    if opt_method == "annealing":
        minlogL = dual_annealing(
            logL_alphaNP, bounds=[(-1e-4, 1e-4)],
            args=(elem, elemsamples, min_percentile),
            maxiter=maxiter)
...
def sample_alphaNP_fit(
    ...
    for x in x_range:
        ...
        #     "alphas_exps": np.array(alphas_exps),
        #     "delchisqs_exps": np.array(delchisqs_exps),
        #     "delchisqcrit": delchisqcrit,
        #     "best_alpha_pts": best_alpha_pts,
        #     "sig_alpha_pts": sig_alpha_pts,
        #     "LB": LB,
        #     "sig_LB": sig_LB,
        #     "UB": UB,
        #     "sig_UB": sig_UB,
...
def get_minpos_maxneg_alphaNP_bounds(alphaNPs, sigalphaNPs, nsigmas=2):
    ...
    minpos_alphas = np.nanmin(alphaNPs, axis=1)
    maxneg_alphas = np.nanmax(alphaNPs, axis=1)
